...
/// <summary>
/// Emits per-entity I&lt;Entity&gt;Queries interfaces into
/// Application/Features/&lt;Plural&gt;/Abstractions/.
/// </summary>
public sealed class FeatureQueriesInterfaceEmitter : IEmitter
{
    public IReadOnlyList<EmittedFile> Emit(EmitterContext ctx)
    {
        ...
        foreach (var entity in ctx.Model.Entities)
        {
            ...
            sb.AppendLine();
            sb.AppendLine($"public interface I{name}Queries");
            sb.AppendLine("{");
            ...
            var path = CleanLayout.ApplicationFeatureAbstractionsPath(project, name, $"I{name}Queries");
